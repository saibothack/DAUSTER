                                        ...
                                        <div class="span12">
                                            <div class="contact">
                                                <div class="contact-form">
                                                    ...
                                                    {{ Form::model($charge, array('route' => array('charges.update', $charge->id), 'method' => 'PUT')) }}

                                                    <fieldset>
                                                        <legend>Agregar</legend>
                                                        <div class="control-group field-spacer">
                                                            <div class="control-label" style="width: 200px !important;">
                                                                        <span class="spacer">
                                                                            <span class="before">
                                                                            </span>
                                                                            <span class="text">
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                {{Form::text('charge', null,  array('required' => 'required', 'class' => 'required'))}}
                                                            </div>
                                                        </div>
                                                    </fieldset>
                                                    <div class="control-group">
