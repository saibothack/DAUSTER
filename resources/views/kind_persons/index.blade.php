{{-- \resources\views\kind_persons\index.blade.php --}}
@extends('layouts.app')
                                        ...
                                        <div class="g-content nomargintop nopaddingtop">
                                            ...
                                            <div style="width: 100%; display: inline-flex; margin-bottom: 10px;">
                                                <div style="width: 50% !important;">
                                                    <!-- agregar -->
                                                    <a href="{{ URL::to('kind-persons/create') }}" class="button btn-primary validate">
                                                        Agregar
                                                    </a>
                                                </div>

                                                {!! Form::open(['route' => 'kind-persons.index', 'method' => 'get', 'style' => 'width: 50% !important;']) !!}
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="tdOptions">
                                                                <div style="display: inline-flex;">
                                                                    <a href="{{ URL::to('kind-persons/'.$kindPerson->id.'/edit') }}" class="button button-grey button-2">
                                                                        <i class="fa fa-fw fa-edit"></i>
                                                                    </a>

                                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['kind-persons.destroy', $kindPerson->id] ]) !!}
