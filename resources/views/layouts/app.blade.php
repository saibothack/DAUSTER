            ...
            <div class="g-grid">
                <div class="g-block size-25">
                    <div class="g-content g-particle" id="logo-9234-particle">
                        <a class="g-logo" href="/dauster/public/web" rel="" title="Kraken">
                            <img alt="Kraken"
                                 src="{{asset('/web/templates/rt_kraken/images/logo/logo-alt.png?5b90d7c0')}}"/>
                            <span>
                                        Dauster
                                    </span>
                        </a>
                ...
                <div class="g-block size-50">
                    <div class="g-content g-particle" id="copyright-7892-particle">
                        <div class="g-copyright ">
                            Copyright © 2007 - 2018
                            <a href="/dauster/public/web/" target="_blank" title="RocketTheme LLC">
                                RocketTheme LLC
                            </a>
                        </div>
                    </div>
