...
@section('content')
                                                        ...
                                                        <div class="col-10">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 text-center">
                                                                    <button class="button btn-info validate" type="button" id="btnUserImage">Imagen usuario</button>
                                                                </div>
                                                                <div class="col-md-6 text-center">
                                                                    <button class="button btn-info validate" type="button" id="btnVehicleImage">Imagen vehículo</button>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 text-center">
                                                                    @IF($user->img_user != "")
                                                                        <img src="{{$user->img_user}}" alt="Imagen de usuario" class="card-image-profiler">
                                                                    @ENDIF
                                                                </div>
                                                                <div class="col-md-6 text-center">
                                                                    @IF($user->img_vehicle != "")
                                                                        <img src="{{$user->img_vehicle}}" alt="Imagen de Vehículo" class="card-image-profiler">
                                                                    @ENDIF
                                                                </div>
                                                            </div>
                                                            <br>
    ...
    <div id="dialog-user-iamge" title="Cambiar Imagen">
        <fieldset>
            {{ Form::open(array('url' => 'user-image', 'class' => 'row', 'method' => 'POST', 'files'=>'true')) }}
            <div class="form-group row">
                {{Form::label('image', 'Imagen *', array('class' => 'col-sm-3 col-form-label text-right'))}}
                <div class="col-sm-9">
                    {{ Form::file('image', null, array('class' => 'form-control', 'required' => 'required')) }}
    ...
    <div id="dialog-vehicle-iamge" title="Cambiar Imagen">
        <fieldset>
            {{ Form::open(array('url' => 'vehicle-image', 'class' => 'row', 'method' => 'POST', 'files'=>'true')) }}
            <div class="form-group row">
                {{Form::label('image', 'Imagen *', array('class' => 'col-sm-3 col-form-label text-right'))}}
                <div class="col-sm-9">
                    {{ Form::file('image', null, array('class' => 'form-control', 'required' => 'required')) }}
